...
<script type="text/javascript" src="{{asset('vendor/qz-tray/js/sample/whatwg-fetch-3.0.0.min.js')}}"></script>
...
<script type="text/javascript" src="{{asset('vendor/qz-tray/js/sample/bootstrap.min.js')}}"></script>
<link rel="stylesheet" href="{{asset('vendor/qz-tray/css/font-awesome.min.css')}}" />
<link rel="stylesheet" href="{{asset('vendor/qz-tray/css/bootstrap.min.css')}}" />
<link rel="stylesheet" href="{{asset('vendor/qz-tray/css/style.css')}}" />
<link rel="stylesheet" href="{{asset('vendor/qz-tray/css/gh-fork-ribbon.min.css')}}" />
...
<script>
    ...
    qz.security.setCertificatePromise(function (resolve, reject) {
        fetch('/qz/certificate', {
            ...
            .then(response => {
                if (!response.ok) throw new Error('Certificate load failed');
                return response.text();
            })
            .then(cert => {
                resolve(cert); // 🔑 MUST be plain text
            })
            .catch(err => {
        ...
        return function (resolve, reject) {
            fetch('/qz/sign', {
                ...
                .then(function(response) {
                    if (!response.ok) return response.text().then(text => reject(text));
                    return response.text();
                })
                .then(function(signature) {
                    resolve(signature);  // actual string, not a Promise
                })
                .catch(function(err) {
                    reject(err);
                });
    ...
    function printHex() {
        ...
        switch(lang) {
            case 'EPL':
                ...
                printData = [
                    { flavor: 'hex', data:
                            '0a4e0a713831320a51313231382c32363b207120616e6420' +
                            '512076616c7565732065646974656420746f207265666c65' +
                            '63742034783620696e63682073697a652061742032303320' +
                            '6470690a42352c32362c302c31412c332c372c3135322c42' +
                            '2c2231323334220a413331302c32362c302c332c312c312c' +
                            '4e2c22534b55203030303030204d46472030303030220a41' +
                            '3331302c35362c302c332c312c312c4e2c22515a2d547261' +
                            '79204a617661204170706c69636174696f6e220a41333130' +
                            '2c38362c302c332c312c312c4e2c2254455354205052494e' +
                            '54205355434345535346554c220a413331302c3131362c30' +
                            '2c332c312c312c4e2c2246524f4d2053414d504c452e4854' +
                            '4d4c220a413331302c3134362c302c332c312c312c4e2c22' +
                            '5553494e4720484558220a50312c310a'
                    }
                ];
                break;
            case 'ZPL':
